...
WebUI.callTestCase(findTestCase('Taskbot/botCreation_Test'), [('nameOfTheBot') : GlobalVariable.NONE_INTENT], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Generic/webObjectWithText', [('textValue') : 'Default fallback intent']), 10, 
...
List<WebElement> utterance = WebUiCommonHelper.findWebElements(findTestObject('Slots/listOfUtterance'), 10)
