...
WebUI.verifyElementText(findTestObject('Slots/markedUpEntity'), markedUpValue, FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'platform.Method.toClickOnWebElement'(findTestObject('Slots/trashIcon', [('rowValue') : 1]))

WebUI.verifyElementNotPresent(findTestObject('Slots/markedUpEntity'), 5)