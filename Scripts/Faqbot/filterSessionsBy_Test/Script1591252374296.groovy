...
WebUI.verifyTextPresent(roomID, false, FailureHandling.OPTIONAL)
...
CustomKeywords.'platform.Session.searchByRoomID'(newRoomID)

WebUI.verifyTextPresent(newRoomID, false, FailureHandling.OPTIONAL)
