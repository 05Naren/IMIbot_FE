...
if (WebUI.verifyElementPresent(findTestObject('Generic/nextPage'), 5, FailureHandling.OPTIONAL)) {
    CustomKeywords.'platform.Method.toClickOnWebElement'(findTestObject('Generic/nextPage'))
}

CustomKeywords.'platform.Method.toClickOnWebElement'(findTestObject('Generic/webObjectWithText', [('textValue') : 'Partial match']))
