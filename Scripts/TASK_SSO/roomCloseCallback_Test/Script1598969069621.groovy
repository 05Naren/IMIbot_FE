...
List<Object> getRoomIdAt = CustomKeywords.'platform.Utility.getRoomID'()
...
WebUI.verifyElementPresent(findTestObject('NewRepo2/errorIcon'), 5, FailureHandling.STOP_ON_FAILURE)
