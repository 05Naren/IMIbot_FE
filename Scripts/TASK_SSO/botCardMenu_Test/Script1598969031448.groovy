...
List<StringBuilder> botCardOptions = CustomKeywords.'platform.Method.verifyBotCardMenu'('Task bots', GlobalVariable.TASK_BOT)
...
CustomKeywords.'platform.Method.clickOnElement'(findTestObject('Generic/webObjectWithText', [('textValue') : GlobalVariable.TASK_BOT]))
